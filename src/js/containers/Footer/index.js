      ...
      <footer>
        <div className="wrapper">
          <div className="first">
            ...
            <p>
              Мы здесь, чтобы ответить на любые вопросы, которые могут
              возникнуть в отношении нашей компании. Обратитесь к нам, и мы в
              скором времени вам ответим.
            </p>
            <span>
              <a href="kupecheskiydom.com">(c) kupecheskiydom.com</a>
            </span>
          </div>
