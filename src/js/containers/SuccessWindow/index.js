...
class SuccessWindow extends Component {
    ...
    correctContent(data){
        ...
        switch (true) {
            ...
            case data.success.bool: return <SuccessContent data={data.success}/>
            break;

            case data.errror.bool: return <SuccessContent data={data.errror}/>
            break;

            case data.successCont.bool: return <SuccessContent data={data.successCont}/>
            break;

            case data.fieldError.bool: return <SuccessContent data={data.fieldError}/>
            break;
