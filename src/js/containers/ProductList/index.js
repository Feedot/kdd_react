            ...
            <div>
                ...
                <article className={this.props.name}>
                    ...
                    <div  className="filter" >
                        ...
                        <button className="filt_but" onClick={this.showMobileFilter.bind(this)}><img src={filterIcon} alt=""/></button>

                        <Link to={"/basket"}><img src={cartIcon} alt=""/></Link>

                    </div>

                    {this.props.items.map((item,index)=>{

                        if((this.props.filterType === item.type || this.props.filterType === 'allProducts')
