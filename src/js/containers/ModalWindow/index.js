...
class ModalWindow extends Component {
    ...
    componentDidMount(){
            ...
            window.document.onscroll = (e) =>{
                ...
                let modalPage = document.getElementsByClassName('modal_page')[0] || document.getElementsByClassName('side_bar active')[0];

                if(modalPage && !stopScrolling) stopScrolling = e.target.scrollingElement.scrollTop;
        ...
        if(this.props.openedProduct){
            ...
            return (
                ...
                <div className={this.props.commonClasses.mainWrapper}>
                    ...
                    <SuccessWindow name={this.props.commonClasses.contentPage} data={this.props.windowOfSaled} />
