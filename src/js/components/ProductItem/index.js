        ...
        return (
            ...
            <div className={this.props.classes.mainWrapper}>
                ...
                <div className="button_group">
                    <span className={this.props.classes.priceClassName}>{ "₽" + this.activeItem.price}</span>
                    <button className={classMore} onClick={this.showModalWindow.bind(this)}> + Добавить</button>
                    <button className={classInBasket} onClick={this.showModalWindow.bind(this)}>В корзине</button>
                </div>
