      ...
      <section>
        ...
        <div className={"flex_wrapper"}>
          ...
          <figure>
            ...
            <div className="p_wrapper">
              <p>
                постоянное <br />обновление ассортимента
              </p>
            </div>
          </figure>
          <figure>
            ...
            <div className="p_wrapper">
              <p>
                поставка<br /> товаров по спецзаказу
              </p>
            </div>
          </figure>
          <figure>
            ...
            <div className="p_wrapper">
              <p>
                наличие собственного <br /> сервисного центра
              </p>
            </div>
          </figure>
          <figure>
            ...
            <div className="p_wrapper">
              <p>
                система скидок<br /> для<br /> крупных клиентов
              </p>
            </div>
          </figure>
        </div>
